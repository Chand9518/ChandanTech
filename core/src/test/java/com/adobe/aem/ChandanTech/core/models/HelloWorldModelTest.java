 ...
 */
package com.adobe.aem.ChandanTech.core.models;
...
import com.adobe.aem.ChandanTech.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "ChandanTech/components/helloworld");
